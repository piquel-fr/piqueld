...
fn service_fields(section: Section, form: RwSignal<ServiceForm>) -> View {
    match section {
        Section::General=>view!{<div class="form-grid">{text_input("Container image",form,|v|v.image.clone(),|v,s|v.image=s)}{text_input("Replicas",form,|v|v.replicas.clone(),|v,s|v.replicas=s)}</div>}.into_view(),
